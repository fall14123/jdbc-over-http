...
public class HttpJdbcDatabaseMetaData implements DatabaseMetaData {
    private final Connection connection;

    public HttpJdbcDatabaseMetaData(Connection connection) {
    ...
    public String getURL() throws SQLException {
        return "jdbc:http://localhost:9999/";
    }
